...
function App() {
  ...
  function touchDown(e) {
    e.target.className === 'homeButtons__touchdown' ? setHomeScore(homeScore + 7) : setAwayScore(awayScore + 7);
  }

  function fieldGoal(e) {
    e.target.className === 'homeButtons__fieldGoal' ? setHomeScore(homeScore + 3) : setAwayScore(awayScore + 3);
  }
